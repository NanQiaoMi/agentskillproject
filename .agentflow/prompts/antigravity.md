...
1. **六轮深度访谈机制与中文提问规范**：你必须主动向用户进行**至少 6 轮的深度访谈**（利用提问或交互式询问），每轮只提出 1-2 个聚焦核心问题，不能草率应付或一次性问完。**特别注意：提问环节必须全部使用中文。如果调用 `ask_question` 等提问工具，问题内容及所有给出的供选择的答案选项（options）必须完全使用中文，绝对禁止使用英文选项。**
